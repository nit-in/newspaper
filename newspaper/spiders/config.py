...
BUSINESS_STANDARD = "https://www.business-standard.com/request-handler/article/ajax-search?keyword="
BUSINESS_STANDARD_PRINT = "https://www.business-standard.com/article/printer-friendly-version?article_id="
ECONOMIC_TIMES = "https://economictimes.indiatimes.com/topics_all.cms?type=article&query="
...
PDFKIT_OPTIONS = {'page-size':'A4','encoding': "UTF-8",
                'enable-javascript':'','javascript-delay':'5000',
                'images':'','background':'','no-stop-slow-scripts':''}
